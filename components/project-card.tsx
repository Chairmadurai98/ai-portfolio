...
export function ProjectCard({ project, isLarge = false, onSelect }: ProjectCardProps) {
  if (isLarge) {
    return (
      <Card
        glowOnHover
        className="group relative overflow-hidden bg-[#0c0e11]/90 border-white/[0.1] h-full flex flex-col justify-between"
      >
        ...
        <div>
          ...
          <div className="p-6 sm:p-8 pb-4">
            ...
            <div className="relative rounded-xl border border-white/[0.08] bg-[#090b0e] p-5 mb-6 overflow-hidden">
  ...
  return (
    <Card
      glowOnHover
      className="group relative overflow-hidden bg-[#0c0e11]/85 border-white/[0.08] flex flex-col justify-between h-full"
    >
      <div className="p-6">
